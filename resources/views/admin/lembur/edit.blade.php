                    ...
                    <div class="card-body p-3">
                        ...
                        <form action="{{ route('admin.lembur.update', $lembur->id) }}" method="POST">
                            ...
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                ...
                                <input class="form-control" style="width: 80%;" type="date" name="tanggal" value="{{ old('tanggal',date('d/m/Y',strtotime($lembur->tanggal))) }}">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="dari_jam">Dari Jam</label>
                                <input class="form-control" style="width: 80%;" type="time" id="dari_jam" name="dari_jam" value="{{ old('dari_jam',$lembur->dari_jam) }}">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="sampai_jam">Sampai Jam</label>
                                <input class="form-control" style="width: 80%;" type="time" onchange="hitungTotalJam()" id="sampai_jam" name="sampai_jam" value="{{ old('sampai_jam',$lembur->sampai_jam) }}">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="total_jam">Total Jam Lembur</label>
                                <input class="form-control" style="width: 80%;" type="text" id="total_jam" name="total_jam" value="{{ old('total_jam',$lembur->total_jam) }}">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="upah_perjam">Upah Perjam</label>
                                <input class="form-control" style="width: 80%;" type="text" onclick="hitungUpahLembur()" id="upah_perjam" name="upah_perjam" value="{{ old('upah_perjam',$lembur->upah_perjam) }}">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="upah_lembur">Upah Lembur</label>
                                <input class="form-control" style="width: 80%;" type="text" id="upah_lembur" name="upah_lembur" value="{{ old('upah_lembur',$lembur->upah_lembur) }}">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="keterangan">Keterangan Lembur</label>
                                <input class="form-control" style="width: 80%;" type="text" name="keterangan" value="{{ old('keterangan',$lembur->keterangan) }}">
                            </div>
