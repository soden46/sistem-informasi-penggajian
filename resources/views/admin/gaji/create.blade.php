                    ...
                    <div class="card-body p-3">
                        ...
                        <form action="{{ route('admin.gaji.store') }}" method="POST">
                            ...
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                ...
                                <input class="form-control" style="width: 80%;" type="number" onchange="hitungTotalGaji()" id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok') }}" min="0">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="transportasi">Transportasi</label>
                                <input class="form-control" style="width: 80%;" type="number" onchange="hitungTotalGaji()" id="transportasi" name="transportasi" value="{{ old('transportasi') }}" min="0">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="uang_makan">Uang Makan</label>
                                <input class="form-control" style="width: 80%;" type="number" onchange="hitungTotalGaji()" id="uang_makan" name="uang_makan" value="{{ old('uang_makan') }}" min="0">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
                                <label class="m-0" for="potongan">Potongan</label>
                                <input class="form-control" style="width: 80%;" type="number" onchange="hitungTotalGaji()" id="potongan" name="potongan" value="{{ old('potongan') }}" placeholder="isi angka 0 jika tidak ada potongan" min="0">
                            </div>
                            <div style="gap: .5rem;flex-wrap: wrap;" class="form-group justify-content-between d-flex align-items-center mb-5">
